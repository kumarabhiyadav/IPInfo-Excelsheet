    ...
    <div className="App">
      ...
      <div>
        ...
        {history.map(item => (
          ...
          }} style={{cursor:'pointer'}} key={item.file}>{item.file} { item.status == "done" ? <img height={18} src="https://img.icons8.com/fluency/48/download.png" alt="" />:<img height={18}  src={loadingIcon} alt="" /> } ${new Date(item.createdAt).toLocaleString()} </li> // Replace with your data structure
        ))}
